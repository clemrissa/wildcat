...
// #include "RenderWidgets/BodyRenderWidget"
// #include "RenderWidgets/HeaderRenderWidget"

// #include "SectionControllers/MultiWellSectionController"
// #include "SectionViews/MultiWellSectionView"

// #include "Scalers/AxisScaler"
...
LogViewerWidget()
  ...
  // p->headerScaler =
  // Scalers::Scaler::Pointer(new Scalers::Scaler(xScaler, yHeaderScaler));
  // p->bodyScaler =
  // Scalers::Scaler::Pointer(new Scalers::Scaler(xScaler, yBodyScaler));
  ...
  // setCentralWidget(p->verticalSplitter = new QSplitter(Qt::Vertical));
