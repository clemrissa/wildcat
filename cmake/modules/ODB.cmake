...
function(odb_compile)
  ...
  #add_custom_target(_odb_target ALL DEPENDS ${output_files})
  #add_library(_odb_target STATIC ${output_files} ${PARAM_HEADER})
  #target_include_directories(_odb_target PUBLIC ${PARAM_INCLUDE})
  #target_link_libraries(${PARAM_TARGET} ${_mode} _odb_target)
  # set_target_properties(ODB PROPERTIES APPEND_STRING PROPERTY 
  #   COMPILE_FLAGS "${CMAKE_INCLUDE_SYSTEM_FLAG_CXX} /foo/bar")
  #add_dependencies(${PARAM_TARGET} _odb_target)
